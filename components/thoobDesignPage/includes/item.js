    ...
    if (item.cost || item.description) {
      ...
      return (
        <div
          ...
          data-cost={item.cost}
        >
          <div className="image image__with__desc itemContentDesc">
            {item.image &&<div className="image__img p-2">
              <img src={item.image} className="w-100" style={{maxHeight: "120px"}} />
            </div>}
            {!item.image && <div className="itemImage">
      ...
      return (
        ...
        >
            <div className="itemImage p-2">
              <img src={image} className="w-100" style={{maxHeight: "120px"}} />
            </div>
